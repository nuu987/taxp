...
2. 最低安卓版本不低于安卓 7（当前暂不支持安卓 6，请以本页面说明为准），由于主流免 root 框架均不支持安卓 7，可使用我专为此项目适配的概念验证版 [LSPatch ver Nougat](https://github.com/nuu987/LSPatch-Ver-Nougat)，需自行构建，暂不提供预编译 apk
...
# 演示
<p align="center">
   <img src="https://images2.imgbox.com/1f/18/FYsLLrGz_o.png" style="width:50%; height:auto;"><br/>在移动设备上运行 ARM64 版 TAXP 模块
</p>
